    ...
    render() {
        ...
        return (
            <Navbar color="white" light expand>
                ...
                <Collapse navbar>
                    <h1 className="text-center ml-auto mt-1 text-primary font-weight-bold  navbar__title d-none d-sm-block">Dự án sản xuất thử nghiệm: Trang trại trồng trọt nông nghiệp công nghệ cao</h1>
